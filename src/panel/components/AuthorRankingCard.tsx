...
import { AuthorRankingItem } from '@/panel/interfaces/stats.interface';
        ...
        <div className="flex gap-4">
          ...
          <div className="relative flex-shrink-0">
            <Avatar className="h-16 w-16">
              {author.avatar && <AvatarImage src={author.avatar} alt={`${author.firstName} ${author.lastName}`} />}
          ...
          <div className="flex-1 min-w-0">
            ...
            <div className="flex items-center gap-1 text-xs text-muted-foreground mb-1">
              ...
              <span>{author.totalBooks} {author.totalBooks === 1 ? 'libro' : 'libros'}</span>
            </div>
            ...
            <div className="flex items-center gap-1 text-xs text-muted-foreground mb-3">
              ...
              <span>
                {author.count} {type === 'read' ? 'lecturas' : 'favoritos'}
              </span>
            </div>
